 ...
 */
function create_playlistfrom_json(t){var i=[];if(null===t||t.length<1)return i;var a=new Date;return a.setMinutes(a.getMinutes()+4),t.forEach(function(t,e){var l={title:t.title,description:t.artist,duration:t.duration,sources:[{src:t.source,type:t.type}],poster:t.poster,thumbnail:t.thumb,size:t.width,folder:t.folder,last_edited_str:t.last_edited_str,purchaselink:t.linktoshop,download:t.download,expires:a},s=[];t.captions&&t.captions.forEach(function(t,e){t={kind:"captions",label:t.label,srclang:t.language,src:t.src};s.push(t)}),l.textTracks=s,i.push(l)}),i}function init_mediaelement(t,e,l){var s=t.firstElementChild,i={rootContainer:t,pluginPath:Default_Skin_vars.player_url+"/js/",playlist:l,stretching:"responsive",classPrefix:"wpcp__",toggleCaptionsButtonWhenOnlyOne:!0,jumpForwardInterval:30,timeAndDurationSeparator:"<span> / </span>",skipBackInterval:10,success:function(t,e){t.options.rootContainer.querySelector(".loading.initialize").style.display="none",t.options.rootContainer.querySelector(".wpcp__main-container").classList.remove("wpcp__loading")},error:function(t,e){void 0!==t.options&&(t.options.rootContainer.querySelector(".loading.initialize").style.display="none",t.options.rootContainer.querySelector(".wpcp__main-container").classList.add("error"))}};i.contextMenuItems=[{render:function(t){return void 0===t.enterFullScreen?null:t.isFullScreen?mejs.i18n.t("mejs.fullscreen-off"):mejs.i18n.t("mejs.fullscreen-on")},click:function(t){t.isFullScreen?t.exitFullScreen():t.enterFullScreen()}},{render:function(t){return t.media.muted?mejs.i18n.t("mejs.unmute"):mejs.i18n.t("mejs.mute")},click:function(t){t.media.muted?t.setMuted(!1):t.setMuted(!0)}}];var a=s.getAttribute("data-controls").split(",");i.displayPlaylist="0"===s.getAttribute("data-hide-playlist"),i.showPlaylistOnload="1"===s.getAttribute("data-open-playlist"),i.playlistInline="1"===s.getAttribute("data-playlist-inline");l=s.getAttribute("data-ads-tag-url");""!==l&&(a.push("vast","ads"),i.vastAdTagUrl=l,i.vastAdsType="vast",l=-1<parseInt(s.getAttribute("data-ads-skip")),(i.adsPrerollAdEnableSkip=l)&&(i.adsPrerollAdSkipSeconds=parseInt(s.getAttribute("data-ads-skip")))),i.speeds=["2","1.75","1.5","1.25","1","0.75","0.5","0.25"],i.defaultSpeed="1",a.push("progress","tracks","contextmenu","googleanalytics","custom_playlist"),i.features=a,wpcp_playlists[e]=new MediaElementPlayer(t.querySelector("video,audio"),i)}function toHHMMSS(t){var e=parseInt(t,10),l=Math.floor(e/3600),t=Math.floor(e/60)%60,e=e%60,e=e<10?"0"+e:e,e=t<10?"0"+t+":"+e:t+":"+e;return 0<l&&(e=l<10?"0"+l+":"+e:l+":"+e),e}!function s(i,a,n){function o(l,t){if(!a[l]){if(!i[l]){var e="function"==typeof require&&require;if(!t&&e)return e(l,!0);if(r)return r(l,!0);e=new Error("Cannot find module '"+l+"'");throw e.code="MODULE_NOT_FOUND",e}e=a[l]={exports:{}};i[l][0].call(e.exports,function(t){var e=i[l][1][t];return o(e||t)},e,e.exports,s,i,a,n)}return a[l].exports}for(var r="function"==typeof require&&require,t=0;t<n.length;t++)o(n[t]);return o}({1:[function(t,e,l){"use strict";mejs.i18n.en["mejs.playlist"]="Toggle Playlist",mejs.i18n.en["mejs.playlist-prev"]="Previous",mejs.i18n.en["mejs.playlist-next"]="Next",mejs.i18n.en["mejs.playlist-loop"]="Loop",mejs.i18n.en["mejs.playlist-shuffle"]="Shuffle",Object.assign(mejs.MepDefaults,{playlist:[],displayPlaylist:!0,showPlaylistOnload:!0,playlistHeight:null,autoClosePlaylist:!1,prevText:null,nextText:null,loopText:null,shuffleText:null,playlistTitle:null,currentMessage:null}),Object.assign(MediaElementPlayer.prototype,{buildcustom_playlist:function(i,t,e,l){var s=mejs.i18n.t("mejs.playlist"),s=mejs.Utils.isString(i.options.playlistTitle)?i.options.playlistTitle:s;i.currentPlaylistItem=0,i.originalControlsIndex=t.style.zIndex,t.style.zIndex=5;t=e.querySelector("."+i.options.classPrefix+"overlay-loading");t&&(t.innerHTML='<div class="loading"><svg class="loader-spinner" viewBox="25 25 50 50"><circle class="path" cx="50" cy="50" r="20" fill="none" stroke-width="3" stroke-miterlimit="10"></circle></svg></div>'),i.playlistLayer=document.createElement("div"),i.playlistLayer.className=i.options.classPrefix+"playlist-layer  "+i.options.classPrefix+"layer "+(!1===i.options.displayPlaylist||!1===i.options.showPlaylistOnload?i.options.classPrefix+"playlist-hidden":"")+" "+i.options.classPrefix+"playlist-selector",i.playlistLayer.innerHTML='<ul class="'+i.options.classPrefix+'playlist-selector-list" data-folder="/" style="max-height:'+(null===i.options.playlistHeight?"none":i.options.playlistHeight)+'"></ul>',i.options.playlistInline&&mejs.Utils.addClass(i.playlistLayer,i.options.classPrefix+"playlist-inline"),e.insertBefore(i.playlistLayer,e.firstChild),i.createWPCPPlayList_(i.playlistLayer.querySelector("ul")),i.playlistButton=document.createElement("div"),i.playlistButton.className=i.options.classPrefix+"button "+i.options.classPrefix+"playlist-button",i.playlistButton.innerHTML='<button type="button" aria-controls="'+i.id+'" title="'+s+'" aria-label="'+s+'" tabindex="0"></button>',i.playlistButton.addEventListener("click",function(){mejs.Utils.toggleClass(i.playlistLayer,i.options.classPrefix+"playlist-hidden"),i.options.playlistInline&&!1===mejs.Utils.hasClass(i.playlistLayer,i.options.classPrefix+"playlist-hidden")?i.pause():i.options.playlistInline&&i.play()}),!0===i.options.displayPlaylist&&1<i.options.playlist.length&&i.addControlElement(i.playlistButton,"playlist"),i.playerDownloadButton=document.createElement("div"),i.playerDownloadButton.className=i.options.classPrefix+"button "+i.options.classPrefix+"download-button",i.playerDownloadButton.innerHTML='<button type="button" aria-controls="'+i.id+'" title="'+mejs.i18n.t("mejs.download-file")+'" aria-label="'+mejs.i18n.t("mejs.download-file")+'" tabindex="0"></button>',i.playerDownloadButton.addEventListener("click",function(){i.playlistLayer.querySelector("."+i.options.classPrefix+'playlist-selector-list-item[data-playlist-index="'+i.currentPlaylistItem+'"]').querySelector("."+i.options.classPrefix+"playlist-item-download").click()}),!1!==i.options.displayPlaylist&&1!==i.options.playlist.length||(i.addControlElement(i.playerDownloadButton,"playerdownload"),void 0!==i.playerDownloadButton&&(!1===i.playlist[i.currentPlaylistItem].download?i.playerDownloadButton.style.display="none":i.playerDownloadButton.style.display="inline-block")),i.playlistLayer.querySelectorAll("."+i.options.classPrefix+"playlist-selector-list-item:not(."+i.options.classPrefix+"playlist-selector-list-item-folder-header)").forEach(function(t){t.addEventListener("click",function(){var t=parseInt(this.getAttribute("data-playlist-index"));i.loadPlaylistItem(t,!1,!0)})}),i.playlistLayer.querySelectorAll("."+i.options.classPrefix+"playlist-selector-list-item-folder-header").forEach(function(s){s.addEventListener("click",function(t){for(var e=t.target;e.parentNode&&e!==s;)e=e.parentNode;var l=e.nextSibling,t=e.querySelector("i");mejs.Utils.hasClass(l,i.options.classPrefix+"playlist-selector-list-item-folder-hidden")?(mejs.Utils.addClass(t,"fa-chevron-circle-down"),mejs.Utils.removeClass(t,"fa-chevron-circle-right"),mejs.Utils.removeClass(l,i.options.classPrefix+"playlist-selector-list-item-folder-hidden")):(mejs.Utils.removeClass(t,"fa-chevron-circle-down"),mejs.Utils.addClass(t,"fa-chevron-circle-right"),mejs.Utils.addClass(l,i.options.classPrefix+"playlist-selector-list-item-folder-hidden"))})}),i.changeLayout(),i.refreshStream=function(){var t;i.readyState<3&&i.playlist[i.currentPlaylistItem].expires<new Date&&(console.debug("RENEW STREAM"),i.pause(),t=i.getCurrentTime(),i.setSrc(i.playlist[i.currentPlaylistItem].src),i.setCurrentTime(t),i.play(),t=new Date,i.playlist[i.currentPlaylistItem].expires=t.setMinutes(t.getMinutes()+4))},i.startProgressCallback=function(){i.refreshStream()},l.addEventListener("progress",i.startProgressCallback),i.playlistPlayCallback=function(){mejs.Utils.addClass(i.container,i.options.classPrefix+"active"),i.refreshStream()},l.addEventListener("play",i.playlistPlayCallback),i.playlistPauseCallback=function(){mejs.Utils.removeClass(i.container,i.options.classPrefix+"active")},l.addEventListener("pause",i.playlistPauseCallback),i.playlistEndedCallback=function(){i.options.loop||(i.currentPlaylistItem<i.playlist.length-1&&i.loadPlaylistItem(i.currentPlaylistItem+1,!0,!0),mejs.Utils.removeClass(i.container,i.options.classPrefix+"active"))},l.addEventListener("ended",i.playlistEndedCallback),i.playlistResizeCallback=function(){},l.addEventListener("playing",i.playlistResizeCallback),l.addEventListener("resize",i.playlistResizeCallback),i.playlistCaptionChangeCallback=function(){void 0!==i.selectedTrack&&null!==i.selectedTrack?i.options.startLanguage=i.selectedTrack.srclang:i.options.startLanguage=null},l.addEventListener("captionschange",i.playlistCaptionChangeCallback),i.lazyLoadingPlaylistItem=function(){var t,e,l,s=i.currentPlaylistItem+1;i.currentTime<1||i.duration<1||void 0===i.playlist[s]||void 0!==i.playlist[s].preloaded||i.currentTime>i.duration-10&&(i.playlist[s].preloaded="busy",t=i.playlist[s].src[0],(e=document.createElement("video")).setAttribute("preload","metadata"),e.setAttribute("muted",!0),e.setAttribute("playsinline",!0),(l=document.createElement("source")).setAttribute("type",t.type),l.setAttribute("src",t.src),e.appendChild(l),e.onloadedmetadata=function(t){i.playlist[s].preloaded=!0},e.onstalled=function(t){i.playlist[s].preloaded=!0},e.load())},"VIDEO"===i.node.nodeName&&(i.floating_container=document.querySelector("."+i.options.classPrefix+"floating-container"),i.inner_container=i.container.children[0],null===i.floating_container&&(i.floating_container=document.createElement("div"),i.floating_container.setAttribute("class",i.options.classPrefix+"floating-container"),document.body.appendChild(i.floating_container)),window.addEventListener("scroll",function(){clearTimeout(i.floatingTimer),i.floatingTimer=setTimeout(function(){var t=i.container.parentNode.getBoundingClientRect().top,e=i.container.offsetHeight,t=Math.floor(t+window.scrollY),e=Math.floor(t+e/2);i.options.isFloating=!1===i.paused&&window.scrollY>e,(i.options.isFloating?i.floating_container:i.container.querySelector("mediaelementwrapper")).appendChild(i.node)},50)})),i.keydownCallback=function(t){var e=mejs.Utils.createEvent("click",t.target);return t.target.dispatchEvent(e),!1},i.playlistLayer.addEventListener("keydown",function(t){var e=t.which||t.keyCode||0;~[13,32,38,40].indexOf(e)&&i.keydownCallback(t)})},cleancustom_playlist:function(t,e,l,s){s.removeEventListener("ended",t.playlistEndedCallback)},buildprevtrack:function(l){var t=mejs.i18n.t("mejs.playlist-prev"),t=mejs.Utils.isString(l.options.prevText)?l.options.prevText:t;l.prevButton=document.createElement("div"),l.prevButton.className=l.options.classPrefix+"button "+l.options.classPrefix+"prev-button",l.prevButton.innerHTML='<button type="button" aria-controls="'+l.id+'" title="'+t+'" aria-label="'+t+'" tabindex="0"></button>',l.prevPlaylistCallback=function(){var t,e;l.playlist[l.currentPlaylistItem-1]&&(t=l.playlistLayer.querySelector("."+l.options.classPrefix+'playlist-selector-list-item[data-playlist-index="'+(l.currentPlaylistItem-1)+'"]'),e=new Event("click"),t.dispatchEvent(e))},l.prevButton.addEventListener("click",l.prevPlaylistCallback),l.options.playlist.length<2||l.addControlElement(l.prevButton,"prevtrack")},cleanprevtrack:function(t){t.prevButton.removeEventListener("click",t.prevPlaylistCallback)},buildnexttrack:function(l){var t=mejs.i18n.t("mejs.playlist-next"),t=mejs.Utils.isString(l.options.nextText)?l.options.nextText:t;l.nextButton=document.createElement("div"),l.nextButton.className=l.options.classPrefix+"button "+l.options.classPrefix+"next-button",l.nextButton.innerHTML='<button type="button" aria-controls="'+l.id+'" title="'+t+'" aria-label="'+t+'" tabindex="0"></button>',l.nextPlaylistCallback=function(){var t,e;l.playlist[l.currentPlaylistItem+1]&&(t=l.playlistLayer.querySelector("."+l.options.classPrefix+'playlist-selector-list-item[data-playlist-index="'+(l.currentPlaylistItem+1)+'"]'),e=new Event("click"),t.dispatchEvent(e))},l.nextButton.addEventListener("click",l.nextPlaylistCallback),l.options.playlist.length<2||l.addControlElement(l.nextButton,"nexttrack")},cleannexttrack:function(t){t.nextButton.removeEventListener("click",t.nextPlaylistCallback)},buildloop:function(t){var e=mejs.i18n.t("mejs.playlist-loop"),e=mejs.Utils.isString(t.options.loopText)?t.options.loopText:e;t.loopButton=document.createElement("div"),t.loopButton.className=t.options.classPrefix+"button "+t.options.classPrefix+"loop-button "+(t.options.loop?t.options.classPrefix+"loop-on":t.options.classPrefix+"loop-off"),t.loopButton.innerHTML='<button type="button" aria-controls="'+t.id+'" title="'+e+'" aria-label="'+e+'" tabindex="0"></button>',t.loopCallback=function(){t.options.loop=!t.options.loop,t.options.loop?(mejs.Utils.removeClass(t.loopButton,t.options.classPrefix+"loop-off"),mejs.Utils.addClass(t.loopButton,t.options.classPrefix+"loop-on")):(mejs.Utils.removeClass(t.loopButton,t.options.classPrefix+"loop-on"),mejs.Utils.addClass(t.loopButton,t.options.classPrefix+"loop-off"))},t.loopButton.addEventListener("click",t.loopCallback),t.addControlElement(t.loopButton,"loop")},cleanloop:function(t){t.loopButton.removeEventListener("click",t.loopCallback)},buildshuffle:function(e){var t=mejs.i18n.t("mejs.playlist-shuffle"),t=mejs.Utils.isString(e.options.shuffleText)?e.options.shuffleText:t;e.shuffleButton=document.createElement("div"),e.shuffleButton.className=e.options.classPrefix+"button "+e.options.classPrefix+"shuffle-button "+e.options.classPrefix+"shuffle-off",e.shuffleButton.innerHTML='<button type="button" aria-controls="'+e.id+'" title="'+t+'" aria-label="'+t+'" tabindex="0"></button>',e.shuffleButton.style.display="none",e.media.addEventListener("play",function(){e.shuffleButton.style.display="",e.resetSize()});function l(){var t;e.options.loop||(t=Math.floor(Math.random()*e.playlist.length),-1===i.indexOf(t)?(e.setSrc(e.playlist[t].src),e.load(),e.play(),e.currentPlaylistItem=t,i.push(t)):i.length<e.playlist.length?e.shuffleCallback():i.length<e.playlist.length&&(i=[],e.currentPlaylistItem=t,i.push(t)))}var s=!1,i=[];e.shuffleCallback=function(){s?(mejs.Utils.removeClass(e.shuffleButton,e.options.classPrefix+"shuffle-on"),mejs.Utils.addClass(e.shuffleButton,e.options.classPrefix+"shuffle-off"),s=!1,e.media.removeEventListener("ended",l)):(mejs.Utils.removeClass(e.shuffleButton,e.options.classPrefix+"shuffle-off"),mejs.Utils.addClass(e.shuffleButton,e.options.classPrefix+"shuffle-on"),s=!0,e.media.addEventListener("ended",l))},e.shuffleButton.addEventListener("click",e.shuffleCallback),e.options.playlist.length<2||e.addControlElement(e.shuffleButton,"shuffle")},cleanshuffle:function(t){t.shuffleButton.removeEventListener("click",t.shuffleCallback)},createWPCPPlayList_:function(l){var e,s,t,o=this;o.playlist=o.options.playlist.length?o.options.playlist:[],o.playlist.length&&(o.listItems=[],o.playlist.sort(function(t,e){var l=0;return t.folder>e.folder?l=1:t.folder<e.folder&&(l=-1),l}),o.playlist.forEach(function(t,e){var i=l,a=1,t=!0===t.folder?[""]:t.folder.split("/"),n="";t.forEach(function(t,e){n+="/"+t.replace(/'/g," ");var l,s=o.playlistLayer.querySelector("ul[data-folder='"+n+"']");null===s&&((s=document.createElement("UL")).classList.add(o.options.classPrefix+"playlist-selector-list-item-folder",o.options.classPrefix+"playlist-selector-list-item-folder-hidden"),s.setAttribute("data-folder",n),""!==t&&((l=document.createElement("LI")).classList.add(o.options.classPrefix+"playlist-selector-list-item",o.options.classPrefix+"playlist-selector-list-item-folder-header"),l.setAttribute("data-folder",n),l.setAttribute("data-depth",a),l.style.paddingLeft=32*(a-1)-16+"px",l.innerHTML='<div class="'+o.options.classPrefix+'playlist-item-content"><div class="'+o.options.classPrefix+'playlist-item-title"><span><i class="fas fa-chevron-circle-right"></i> '+t+"</span></div></div></div>",i.appendChild(l)),i.appendChild(s)),i=s,a+=1})}),o.playlist.forEach(function(t,e){var l=document.createElement("li"),s=(o.id,!0===t.folder?[""]:t.folder.split("/")),i=o.playlistLayer.querySelector("ul[data-folder='/"+t.folder.replace(/'/g," ")+"']"),a=s.length;o.playlist[e].src=t.sources,l.tabIndex=0,l.className=o.options.classPrefix+"playlist-selector-list-item"+(0===e?" "+o.options.classPrefix+"playlist-selected":""),""!==s[0]?(l.style.paddingLeft=32*a+"px",l.setAttribute("data-depth",a)):l.setAttribute("data-depth",0),l.setAttribute("data-playlist-index",e),l.innerHTML='<div class="'+o.options.classPrefix+'playlist-item-inner">'+(t.thumbnail?'<div class="'+o.options.classPrefix+'playlist-item-thumbnail"><div class="preloading"></div>'+(0<t.duration?'<div class="'+o.options.classPrefix+'playlist-item-duration"><i class="fas fa-play fa-xs"></i> '+toHHMMSS(t.duration)+"</div>":"")+'<img tabindex="-1" src="'+t.thumbnail+'" title="'+t.title+'" referrerpolicy="no-referrer" loading="lazy"></div>':"")+'<div class="'+o.options.classPrefix+'playlist-item-content"><div class="'+o.options.classPrefix+'playlist-item-title">'+t.title+" "+(0<t.textTracks.length?'<i class="fas fa-closed-captioning"></i>':"")+' <i class="fas fa-volume-up"></i></div>'+(null!==t.description&&0<t.description.length?'<span class="'+o.options.classPrefix+'playlist-item-description">'+t.description+"</span>":"")+"</div>"+(t.last_edited_str?'<div class="'+o.options.classPrefix+'playlist-item-lastedited"><span>'+t.last_edited_str+"</span></div>":"")+(!1!==t.purchaselink?'<a target="_blank" href="'+t.purchaselink+'" class="'+o.options.classPrefix+'playlist-item-purchase" title='+mejs.i18n.t("mejs.purchase")+'><i class="far fa-shopping-basket fa-lg"></i></a>':"")+(!1!==t.download?'<a target="_blank" href="'+t.download+'" class="'+o.options.classPrefix+'playlist-item-download" title='+mejs.i18n.t("mejs.download-file")+'><i class="far fa-arrow-to-bottom fa-lg"></i></a>':"")+"</div>",o.listItems.push(l.outerHTML),i.appendChild(l)}),e=0,s=[],o.playlistLayer.querySelectorAll("."+o.options.classPrefix+"playlist-selector-list-item:not(."+o.options.classPrefix+"playlist-selector-list-item-folder-header)").forEach(function(t){s[e]=o.playlist[t.getAttribute("data-playlist-index")],t.setAttribute("data-playlist-index",e),e++}),o.playlist=s,null===(t=o.playlistLayer.querySelector("li[data-depth='0']"))&&(t=o.playlistLayer.querySelector("."+o.options.classPrefix+"playlist-selector-list-item[data-playlist-index='0']")),t=parseInt(t.getAttribute("data-playlist-index")),o.currentPlaylistItem=t,o.loadPlaylistItem(t,!0,!1))},loadPlaylistItem:function(t,e,l){var s=this,i=s.playlistLayer.querySelector("."+s.options.classPrefix+"playlist-selected"),a=s.playlistLayer.querySelector("."+s.options.classPrefix+"playlist-selector-list-item[data-playlist-index='"+t+"']");s.isVideo&&!0===s.options.autoClosePlaylist&&mejs.Utils.toggleClass(s.playlistLayer,s.options.classPrefix+"playlist-hidden"),mejs.Utils.removeClass(i,s.options.classPrefix+"playlist-selected"),mejs.Utils.addClass(a,s.options.classPrefix+"playlist-selected"),s.openPlaylistSubFolders(a),s.currentPlaylistItem===t&&!0!==e||(s.currentPlaylistItem=t,s.options.googleAnalyticsTitle=s.playlist[t].title+(null!==s.playlist[t].description?" | "+s.playlist[t].description:""),s.setSrc(s.playlist[t].src),s.setPoster(s.playlist[t].poster),s.adsCurrentMediaUrl=s.playlist[t].src,void 0!==s.adsDataIsLoading&&!0===s.adsDataIsLoading||(void 0!==s.playerDownloadButton&&(!1===s.playlist[s.currentPlaylistItem].download?s.playerDownloadButton.style.display="none":s.playerDownloadButton.style.display="inline-block"),s.load(),(s.node.getAutoplay()||l)&&setTimeout(function(){s.play()},200),s.options.features.forEach(function(t){"speed"===t&&void 0===s.speedButton&&s.buildspeed(s,s.getElement(s.controls),s.getElement(s.layers),s.media)})),s.loadPlaylistTracks(s.currentPlaylistItem))},loadPlaylistTracks:function(t){var s=this,t=s.playlist[t].textTracks;s.trackFiles=[],0<t.length&&t.forEach(function(t,e){var l=document.createElement("track");l.kind=t.kind,l.label=t.label,l.src=t.src,l.srclang=t.srclang,s.trackFiles.push(l)}),setTimeout(function(){s.rebuildtracks(),s.changeLayout(),s.loadTrack(0),s.tracks.forEach(function(t,e){t.srclang===s.options.startLanguage&&s.setTrack(t.trackId)})},1e3)},openPlaylistSubFolders:function(t){for(var e=t.parentNode;e.classList.contains(this.options.classPrefix+"playlist-selector-list-item-folder-hidden");)e.previousSibling.click(),e=e.parentNode},changeLayout:function(){var t,e,l=this;void 0===l.leftcontrols&&(t=document.createElement("div"),e=document.createElement("div"),mejs.Utils.addClass(t,l.options.classPrefix+"controls-left"),mejs.Utils.addClass(e,l.options.classPrefix+"controls-right"),l.controls.appendChild(t),l.controls.appendChild(e),l.leftcontrols=t,l.rightcontrols=e),l.controls.querySelectorAll(".wpcp__prev-button, .wpcp__playpause-button, .wpcp__next-button, .wpcp__volume-button, .wpcp__horizontal-volume-slider, .wpcp__currenttime-container, .wpcp__time, wpcp__duration-container").forEach(function(t){l.leftcontrols.appendChild(t)}),l.controls.querySelectorAll(".wpcp__skip-back-button, .wpcp__jump-forward-button, .wpcp__speed-button, .wpcp__shuffle-button, .wpcp__loop-button, .wpcp__download-button, .wpcp__fullscreen-button, .wpcp__playlist-button, .wpcp__captions-button, .wpcp__chromecast-button, .wpcp__airplay-button").forEach(function(t){l.rightcontrols.appendChild(t)}),l.container.parentNode.appendChild(l.playlistLayer)}})},{}]},{},[1]);