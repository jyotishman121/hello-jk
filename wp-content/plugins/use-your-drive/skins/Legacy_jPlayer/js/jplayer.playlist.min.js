...
(function ($, undefined) {
  ...
  jPlayerPlaylist.prototype = {
            ...
            $.each(folders, function (i) {
              ...
              if (new_folder_ul.length === 0) {
                if (new_folder_name !== '') {
                  ...
                  var folder_li = $('<li class="jp-playlist-folder-header" data-folder="' + new_folder_name + '"><span><i class="fas fa-chevron-circle-right"></i> ' + folders[i] + '</span></li>');
    ...
    _createListItem: function (media) {
      ...
      listItem += "<a href='javascript:;' class='" + this.options.playlistOptions.itemClass + "' tabindex='0'><div class='jp-playlist-item-song-title'>" + media.title + " <i class='fas fa-volume-up'></i></div>" + (media.artist ? "<div class='jp-playlist-item-song-artist'>" + media.artist + "</div>" : "") + "</a>";

      // Links and download button
      listItem += "<span class='jp-playlist-item-url'>";
      if (media.linktoshop !== false) {
        listItem += "<a class='jp-playlist-item-sell' href='" + media.linktoshop + "'><i class='far fa-shopping-basket'></i></a>";
      }
      if (media.download !== false) {
        listItem += "<a class='jp-playlist-item-dl' download href='" + media.download + "'><i class='far fa-arrow-to-bottom'></i></a>";
      }
      listItem += "</span>";
    ...
    _createItemHandlers: function () {
      ...
      $(this.cssSelector.playlist).off("click", "li.jp-playlist-folder-header").on("click", "li.jp-playlist-folder-header", function (e) {
        ...
        $(self.cssSelector.playlist).find("ul.jp-playlist-folder[data-folder='" + $header.attr('data-folder').replace(/'/g, " ") + "']").slideToggle(self.options.playlistOptions.removeTime, function () {
          if ($(this).is(':visible')) {
            $header.find('i').removeClass('fa-chevron-circle-right').addClass('fa-chevron-circle-down');
          } else {
            $header.find('i').removeClass('fa-chevron-circle-down').addClass('fa-chevron-circle-right');
          }
        });
    ...
    select: function (index) {
      ...
      $.each($(this.cssSelector.playlist + " li[index='" + (this.current) + "']").parents('.jp-playlist-folder[data-folder!=""]'), function () {
        $(this).slideDown().prev().find('i').removeClass('fa-chevron-circle-right').addClass('fa-chevron-circle-down');
      });
