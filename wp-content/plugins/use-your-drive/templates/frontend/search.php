<div class="list-container" style="width:<?php echo $this->options['maxwidth']; ?>;max-width:<?php echo $this->options['maxwidth']; ?>;">
  <div class="nav-header UseyourDrive" id="search-<?php echo $this->listtoken; ?>">
    <div class="search-div">
      ...
      <input name="q" type="text" size="40" aria-label="<?php echo __('Search', 'wpcloudplugins'); ?>" placeholder="<?php echo __('Search for files', 'wpcloudplugins').(('1' === $this->options['searchcontents'] && '1' === $this->options['show_files']) ? ' '.__('and content', 'wpcloudplugins') : ''); ?>" class="search-input" />
    </div>
  </div>
