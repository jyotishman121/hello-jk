  ...
  <div class="fileupload-header">
    <div class="fileupload-header-title">
      <div class="fileupload-empty">
        <div class="fileupload-header-text-title upload-add-file"><?php echo ($this->options['maxnumberofuploads'] > 1) ? __('Add your files', 'wpcloudplugins') : __('Add your file', 'wpcloudplugins'); ?></div>
          ...
          <ul>
            <li class="upload-add-file">
              <a title="<?php _e('Files', 'wpcloudplugins'); ?>">
                <i class="fas fa-file-medical"></i> <?php echo ($this->options['maxnumberofuploads'] > 1) ? __('Files', 'wpcloudplugins') : __('File', 'wpcloudplugins'); ?>
              </a>
            </li>
            <?php if ('1' === $this->options['upload_folder'] && ($this->options['maxnumberofuploads'] > 1 || '-1' === $this->options['maxnumberofuploads'])) { ?>
