      ...
      <div class="nav-header"><?php if ('1' === $this->options['show_breadcrumb']) { ?>
            ...
            if ('1' === $this->options['search']) {
                ...
                <a class="nav-search">
                  ...
                  <input name="q" type="text" size="40" aria-label="<?php echo __('Search', 'wpcloudplugins'); ?>" placeholder="<?php echo __('Search filenames', 'wpcloudplugins').(('1' === $this->options['searchcontents'] && '1' === $this->options['show_files']) ? ' '.__('and content', 'wpcloudplugins') : ''); ?>" class="search-input" />
                  </div>
            <?php
            } ?>
            ...
            <div class="tippy-content-holder" data-token="<?php echo $this->listtoken; ?>">
              <ul data-id="<?php echo $this->listtoken; ?>">
                ...
                if ($this->get_user()->can_add_folders()) {
                    ?>
                    <li><a class="nav-new-folder newfolder" data-mimetype='application/vnd.google-apps.folder' title="<?php _e('Add folder', 'wpcloudplugins'); ?>"><i class="fas fa-folder-plus"></i><?php _e('Add folder', 'wpcloudplugins'); ?></a></li>
                    <?php
                }
                ...
                if ($this->get_user()->can_create_document()) {
                    ...
                    <li>
                      ...
                      <ul>
                        <li><a class="newentry" data-mimetype='application/vnd.google-apps.document' title="<?php _e('Google Doc', 'wpcloudplugins'); ?>"><img src="<?php echo \TheLion\UseyourDrive\Helpers::get_default_thumbnail_icon('application/vnd.google-apps.document'); ?>"><?php _e('Google Doc', 'wpcloudplugins'); ?></a></li>
                        <li><a class="newentry" data-mimetype='application/vnd.google-apps.spreadsheet' title="<?php _e('Google Sheet', 'wpcloudplugins'); ?>"><img src="<?php echo \TheLion\UseyourDrive\Helpers::get_default_thumbnail_icon('application/vnd.google-apps.spreadsheet'); ?>"><?php _e('Google Sheet', 'wpcloudplugins'); ?></a></li>
                        <li><a class="newentry" data-mimetype='application/vnd.google-apps.presentation' title="<?php _e('Google Slide', 'wpcloudplugins'); ?>"><img src="<?php echo \TheLion\UseyourDrive\Helpers::get_default_thumbnail_icon('application/vnd.google-apps.presentation'); ?>"><?php _e('Google Slide', 'wpcloudplugins'); ?></a></li>
                      </ul>
                    </li>
                <?php
                }
