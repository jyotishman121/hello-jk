  ...
  <div class="useyourdrive admin-settings">
    ...
    <div class="wrap">
      <div class="useyourdrive-header">
        ...
        <div class="useyourdrive-form-buttons"> <div id="clear_statistics" class="simple-button default clear_statistics" name="clear_statistics"><?php _e('Clear all Statistics','wpcloudplugins'); ?>&nbsp;<div class='uyd-spinner'></div></div></div>

        <div class="useyourdrive-title"><?php _e('Reports','wpcloudplugins'); ?></div>
      </div>
      ...
      <div class="useyourdrive-panel">
        <div id="useyourdrive-totals">
          <div class="useyourdrive-box useyourdrive-box25">
            <div class="useyourdrive-box-inner ">
              <div class="useyourdrive-option-title nopadding">
                <div class="useyourdrive-counter-text"><?php echo __('Total Previews', 'wpcloudplugins'); ?> </div>
          ...
          <div class="useyourdrive-box useyourdrive-box25">
            <div class="useyourdrive-box-inner">
              <div class="useyourdrive-option-title nopadding">
                <div class="useyourdrive-counter-text"><?php echo __('Total Downloads', 'wpcloudplugins'); ?></div>
          ...
          <div class="useyourdrive-box useyourdrive-box25">
            <div class="useyourdrive-box-inner">
              <div class="useyourdrive-option-title nopadding">
                <div class="useyourdrive-counter-text"><?php echo __('Items Shared', 'wpcloudplugins'); ?></div>
          ...
          <div class="useyourdrive-box useyourdrive-box25">
            <div class="useyourdrive-box-inner">
              <div class="useyourdrive-option-title nopadding">
                <div class="useyourdrive-counter-text"><?php echo __('Documents Uploaded', 'wpcloudplugins'); ?></div>
        ...
        <div class="useyourdrive-box">
          <div class="useyourdrive-box-inner">
            ...
            <div class="useyourdrive-option-title"><?php echo __('Events per Day', 'wpcloudplugins'); ?></div>
        ...
        <div class="useyourdrive-box useyourdrive-box50">
          <div class="useyourdrive-box-inner">
            <div class="useyourdrive-option-title"><?php echo __('Top 25 Downloads', 'wpcloudplugins'); ?></div>
        ...
        <div class="useyourdrive-box useyourdrive-box50">
          <div class="useyourdrive-box-inner">
            <div class="useyourdrive-option-title"><?php echo __('Top 25 Users with most Downloads', 'wpcloudplugins'); ?></div>
        ...
        <div class="useyourdrive-box">
          <div class="useyourdrive-box-inner">
            ...
            <div class="useyourdrive-option-title"><?php echo __('All Events', 'wpcloudplugins'); ?></div>
        ...
        <div class="event-details-template" style="display:none;">
            ...
            <div class="useyourdrive-box-inner">
              ...
              <div class="event-details-totals-template">
                <div class="useyourdrive-option-title tbpadding10 ">
                  <div class="useyourdrive-counter-text"><?php echo __('Previews', 'wpcloudplugins'); ?> </div>
                  <div class="useyourdrive-counter" data-type="useyourdrive_previewed_entry">
                    <span>
                      <div class="loading"><div class='loader-beat'></div></div>
                    </span>
                ...
                <div class="useyourdrive-option-title tbpadding10">
                  <div class="useyourdrive-counter-text"><?php echo __('Downloads', 'wpcloudplugins'); ?></div>
                  <div class="useyourdrive-counter" data-type="useyourdrive_downloaded_entry">
                    <span>
                      <div class="loading"><div class='loader-beat'></div></div>
                    </span>
                ...
                <div class="useyourdrive-option-title tbpadding10">
                  <div class="useyourdrive-counter-text"><?php echo __('Shared', 'wpcloudplugins'); ?></div>
                  <div class="useyourdrive-counter" data-type="useyourdrive_created_link_to_entry">
                    <span>
                      <div class="loading"><div class='loader-beat'></div></div>
                    </span>
                ...
                <div class="useyourdrive-option-title tbpadding10">
                  <div class="useyourdrive-counter-text"><?php echo __('Uploads', 'wpcloudplugins'); ?></div>
                  <div class="useyourdrive-counter" data-type="useyourdrive_uploaded_entry">
                    <span>
                      <div class="loading"><div class='loader-beat'></div></div>
                    </span>
          ...
          <div class="useyourdrive-box useyourdrive-box75 event-details-table-template">
            <div class="useyourdrive-box-inner">
              <div class="useyourdrive-option-title"><?php echo __('Logged Events', 'wpcloudplugins'); ?></div>
