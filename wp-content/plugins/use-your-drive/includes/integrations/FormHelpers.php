            ...
            <?php foreach ($uploaded_files as $fileid => $file) {            ?>
                <tr style="<?php echo ($current % 2) ? 'background: #fafafa;' : ''; ?> height: 26px;">
                    <td style="width:20px;padding-right:10px;padding-left: 5px;">
                        <img alt="" height="16" src="<?php echo \TheLion\UseyourDrive\Helpers::get_default_thumbnail_icon($file->type); ?>" style="border:0;display:block;outline:none;text-decoration:none;height:auto;width:100%;" width="16">
                    </td>
