(function ($) {
    ...
    $('#frm_builder_page').on('click', '.useyourdrive.open-shortcode-builder', function () {
        ...
        tb_show("Build Shortcode for Form", ajaxurl + '?action=useyourdrive-getpopup&' + query + '&type=shortcodebuilder&asuploadbox=1&callback=wpcp_uyd_formidableforms_add_content&TB_iframe=true&height=600&width=800');
    ...
    if (typeof window.wpcp_uyd_formidableforms_add_content === 'undefined') {
        window.wpcp_uyd_formidableforms_add_content = function (data) {
