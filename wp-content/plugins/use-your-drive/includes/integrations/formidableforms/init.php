...
class FormidableForms
{
    ...
    public function field_options_form($field, $display, $values)
    {
        ...
        <tr>
            ...
            <a href="#" class='button-primary useyourdrive open-shortcode-builder'><?php _e('Build your shortcode', 'wpcloudplugins'); ?></a>
            </td>
        </tr>
        <?php
    }
    ...
    public function validation($errors, $posted_field, $posted_value, $args)
    {
        ...
        if (empty($uploaded_files) || (count((array) $uploaded_files) === 0)) {
